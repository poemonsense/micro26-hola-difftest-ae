...
\end{itemize}
Run the following three numbered commands in order.  No other commands are
required for the complete evaluation.
...
Run Command 2 from the artifact repository root.
...
The initial run requires network access for missing packages and uncached
dependencies.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Experiment workflow}

Run Command 3 from the artifact repository root.  It executes the complete AE
workflow; no additional commands are required.
...
\paragraph{Additional explanation (no action required).}
Command 3 automatically invokes four fail-fast stages:
